...
<Info>
  **Optional Feature: Scheduling required**
  ...
  If you haven't already turned this on, before you can set up your Xero Integration for syncing your Timesheet Batches - you will need to enable **Scheduling** via your [**Optional Features**](https://app.astalty.com.au/settings/optional-features) page in Settings.

  For more on how to enable Optional Features - [**click here**](https://docs.astalty.com.au/guide/settings/optional-features)
</Info>
